...
char imei[15] = { 
h  0     }; // MUST use a 16 character buffer for IMEI!
#endif // ENABLE_GSM
...
// 5110 LCD
Adafruit_PCD8544 display = Adafruit_PCD8544(A3, 4, 5, 7, 8);
...
uint8_t dispbuffer[84*54/8];

// teeth
static const unsigned char PROGMEM teeth_bmp[] =
{
0x3f,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xe0,
0x1f,0xff,0xfd,0xff,0xff,0xdf,0xff,0xfd,0xff,0xff,0xc0,
0x1f,0xff,0xfd,0xff,0xff,0xdf,0xff,0xfd,0xff,0xff,0xc0,
0xf,0xff,0xf8,0xff,0xff,0x8f,0xff,0xf8,0xff,0xff,0x80,
0x7,0xff,0xf0,0x7f,0xff,0x7,0xff,0xf0,0x7f,0xff,0x0,
0x7,0xff,0xf0,0x7f,0xff,0x7,0xff,0xf0,0x7f,0xff,0x0,
0x3,0xff,0xe0,0x3f,0xfe,0x3,0xff,0xe0,0x3f,0xfe,0x0,
0x1,0xff,0xc0,0x1f,0xfc,0x1,0xff,0xc0,0x1f,0xfc,0x0,
0x1,0xff,0xc0,0x1f,0xfc,0x1,0xff,0xc0,0x1f,0xfc,0x0,
0x0,0xff,0x80,0xf,0xf8,0x0,0xff,0x80,0xf,0xf8,0x0,
0x0,0x7f,0x0,0x7,0xf0,0x0,0x7f,0x0,0x7,0xf0,0x0,
0x0,0x7f,0x0,0x7,0xf0,0x0,0x7f,0x0,0x7,0xf0,0x0,
0x0,0x3e,0x0,0x3,0xe0,0x0,0x3e,0x0,0x3,0xe0,0x0,
0x0,0x1c,0x0,0x1,0xc0,0x0,0x1c,0x0,0x1,0xc0,0x0,
0x0,0x1c,0x0,0x1,0xc0,0x0,0x1c,0x0,0x1,0xc0,0x0,
0x0,0x8,0x0,0x0,0x80,0x0,0x8,0x0,0x0,0x80,0x0,
...
// Setup Nokia LCD
void setup5110Display() {
  display.setBuffer(dispbuffer);
  display.begin();
...
// print to Nokia
void writeTo5110(char c) {
  char temp[29];
  if (lcdPos != 27) {
    lcdPos++;
  }
  else { // full buffer, scroll
    memcpy(temp, &lcdBuffer[1], 27);
    memcpy(lcdBuffer, temp, 28);
  }
  lcdBuffer[lcdPos] = c;
  display.clearDisplay();
  display.drawBitmap(0, 0,  teeth_bmp, 84, 48, 1);
  display.setCursor(0,16);  
  display.print(lcdBuffer);
  display.display();  
}
